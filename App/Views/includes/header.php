        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-content">
                    ...
                    <form class="formularioR">
                        ...
                        <div class="contenedor">
                            <div class="input-contenedor">
                                ...
                                <input id="email" name ="email"type="text" placeholder="Correo" value="nail@gmail.com" >
                            </div>
                            <div class="input-contenedor">
                                <i class="fas fa-key icon"></i>
                                <!--Carga icono del la pagina-->
                                <input type="password" id="password" name="password" placeholder="Clave" value="000000">
                            </div>
                        </div>
                    </form>
                ...
                <div class="modal-body">
                    ...
                    <p>¿No tienes Cuenta? <a href="#" class="link" data-target="#ventanamodalR" data-toggle="modal"> Regístrate. </a> </p>
  ...
  <script type="text/javascript" >
      $(document).ready(function() {
          chekeaSesionAbiertas();//Chekea que exita un Moderador con la cuenta Abiert
           ...
           var datos;
           var url = $('#url').val();
        $('#btnEntrar').click(function(){ //Funcion Clic.
        ...
        function enviarInformacion(accion,objDatos,modal){
                $.ajax({
                url:url+'App/Controllers/validarUserControllers.php?accion='+accion,
                    ...
                    if (msj==false){
                        ...
                        $.each(JSON.parse(msj), function(index, data) {
                            nombre= "("+data.first_name+" "+data.last_name+")";
                        });

                        creaSesionLocalModerador(nombre);
        ...
        function opcionesDelModerador(data){//Nail Moderador
         ...
         var html = "";
            ...
            html += '<a href="" id="linkCerar" class="dropdown-item">Cerrar Sesion</a>';
            html += '</div>';
